...
urlpatterns = [
    ...
    path('v1/user/search/<str:username>/', UserSearchView.as_view(), name="user_search_view"),
    ...
    path('v1/github_user/search/<str:login>/', UserGithubSearchView.as_view(), name="user_github_search_view"),
